...
contract CrossSourceChainMinter is Ownable {

    // Custom errors to provide more descriptive revert messages.
    error NotEnoughBalance(uint256 currentBalance, uint256 calculatedFees); // Checks if the contract has enough balance to cover the fees.
    ...
    constructor(address destMinterAddress) Ownable(msg.sender) {
